| №  | Title EN | Title RU |
|----|----------|----------|
| 1 | [Create a folder dir_1](task_1) | Сделать папку dir_1 |
| 2 | [Change directory to dir_1](task_2) | Зайти в папку dir_1 |
| 3 | [Create a folder inner_dir_1](task_3) | Создать папку inner_dir_1 |
| 4 | [View the current directory](task_4) | Посмотреть где ты находишься |
| 5 | [Inside dir_1, create an empty text file tf_1.txt](task_5) | Находясь в папке dir_1 создать пустой текстовый файл tf_1.txt |
| 6 | [While inside dir_1, use the cat command to create a text file tf_2.txt with the following lines: - the first 1, - the second 2, - the third 3](task_6) | Находясь в папке dir_1 через команду cat создать текстовый файл tf_2.txt со следующими строками:- the first 1, - the second 2, - the third 3 |
| 7 | [Enter the inner_dir_1 folder](task_7) | Зайти в папку inner_dir_1 |
| 8 | [Use cat to create a text file tf_3.txt with any lines](task_8) | Через cat сделать текстовый файл tf_3.txt c любыми строками |
| 9 | [Use cat to add the line 'the second 2' to the text file tf_3.txt](task_9) | Через cat добавить в текстовый файл tf_3.txt строку 'the second 2' |
| 10 | [Use cat to add the line 'the sec 2' to the text file tf_3.txt](task_10) | Через cat добавить в текстовый файл tf_3.txt строку 'the sec 2' |
| 11 | [Use cat to add the line 'the sec 3' to the text file tf_2.txt](task_11) | Через cat добавить в текстовый файл tf_2.txt строку 'the sec 3' |
| 12 | [Use cat to add the line 'the SeCoNd 2' to the text file tf_3.txt](task_12) | Через cat добавить в текстовый файл tf_3.txt строку 'the SeCoNd 2' |
| 13 | [Use cat to add the line 'the seConD 2' to the text file tf_2.txt](task_13) | Через cat добавить в текстовый файл tf_2.txt строку 'the seConD 2' |
| 14 | [Create a text file tf_4.txt with 15 lines.](task_14) | Сделать текстовый файл tf_4.txt в котором будет 15 строк. |
| 15 | [Create a text file tF_5.txt with 13 lines.](task_15) | Сделать текстовый файл tF_5.txt в котором будет 13 строк. |
| 16 | [List all files in the current folder.](task_16) | Вывести список всех файлов в папке. |
| 17 | [Go back to the parent directory (from inner_dir_1 to dir_1)](task_17) | Выйти из папки inner_dir_1 |
| 18 | [Display the contents of the file tf_3.txt in the terminal.](task_18) | Вывести содержимое файла tf_3.txt в терминал. |
